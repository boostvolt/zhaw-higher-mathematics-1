...
print(
    "Die Laufzeit1 unserer eigenen Funktion beträgt: {} und die Laufzeit von linalg.qr() beträgt {} für eine 3x3 Matrix".format(
        avg_t1, avg_t2
    )
)
print(
...
print(
    "Die Laufzeit unserer eigenen Funktion beträgt: {} und die Laufzeit von linalg.qr() beträgt {} für eine 100x100 Matrix".format(
        avg_t3, avg_t4
    )
)
print(
